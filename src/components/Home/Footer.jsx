  ...
  return (
    <footer className="footer--container">
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Deshini Gayathri</p>
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/deshini_gayathri_2046?igsh=dWp2czE3cTM1OGR1"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/gayathri-deshini-663057272?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
